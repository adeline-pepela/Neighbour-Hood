...
##### Cloning the repository:  
 ```bash 
https://github.com/adeline-pepela/Neighbour-Hood.git
```
...
* [![License](https://img.shields.io/packagist/l/loopline-systems/closeio-api-wrapper.svg)](https://github.com/adeline-pepela/Neighbour-Hood/blob/master/LICENSE)  
